...
public class LambdaTest {
  ...
  public void testTable() {
    ...
    // 2 Group by
    Map<Integer, Long> groupByAgeCounting =
        users.stream().collect(Collectors.groupingBy(u -> u.getAge(), Collectors.counting()));
