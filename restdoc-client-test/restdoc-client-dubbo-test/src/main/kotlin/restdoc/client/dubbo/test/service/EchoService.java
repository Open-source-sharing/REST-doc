...
public interface EchoService {
  ...
  default void echo2(String a) {
    System.err.println(
        String.format("restdoc.client.dubbo.test.service.EchoService.echo2 %s", "Hello Kotlin"));
  }

  default void echo3(String a) {
    System.err.println(
        String.format("restdoc.client.dubbo.test.service.EchoService.echo3 %s", "Hello Java"));
  }
