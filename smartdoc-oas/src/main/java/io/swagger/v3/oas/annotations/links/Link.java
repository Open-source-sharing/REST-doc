...
/**
 * The annotation may be applied in {@link
 * io.swagger.v3.oas.annotations.responses.ApiResponse#links()} to add OpenAPI links to a response.
 *
 * @see <a target="_new"
 *     href="https://github.com/OAI/OpenAPI-Specification/blob/3.0.1/versions/3.0.1.md#linkObject">Link
...
public @interface Link {
  ...
  /**
   * A relative or absolute reference to an OAS operation. This field is mutually exclusive of the
   * operationId field, and must point to an Operation Object. Relative operationRef values may be
   * used to locate an existing Operation Object in the OpenAPI definition. Ignored if the
   * operationId property is specified.
   *
  ...
  /**
   * Array of parameters to pass to an operation as specified with operationId or identified via
   * operationRef.
   *
