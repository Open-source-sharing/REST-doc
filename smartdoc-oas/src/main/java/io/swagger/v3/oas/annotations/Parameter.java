...
/**
 * The annotation may be used on a method parameter to define it as a parameter for the operation,
 * and/or to define additional properties for the Parameter. It can also be used independently in
 * {@link Operation#parameters()} or at method level to add a parameter to the operation, even if
 * not bound to any method parameter.
 *
 * <p>swagger-jaxrs2 reader engine considers this annotation along with JAX-RS annotations,
 * parameter type and context as input to resolve a method parameter into an OpenAPI Operation
 * parameter.
 *
 * <p>For method parameters bound to the request body, see {@link
 * io.swagger.v3.oas.annotations.parameters.RequestBody}
 *
 * @see <a target="_new"
 *     href="https://github.com/OAI/OpenAPI-Specification/blob/3.0.1/versions/3.0.1.md#parameterObject">Parameter
...
public @interface Parameter {
  ...
  /**
   * When true, allows sending an empty value. If false, the parameter will be considered
   * \&quot;null\&quot; if no value is present. This may create validation errors when the parameter
   * is required.
   *
   ...
   * simple; for cookie - form. Ignored if the properties content or array are specified.
   *
   ...
   * the default value is false. Ignored if the properties content or array are specified.
   *
  ...
  /**
   * The schema defining the type used for the parameter. Ignored if the properties content or array
   * are specified.
   *
  ...
  /**
   * The schema of the array that defines this parameter. Ignored if the property content is
   * specified.
   *
   ...
   * string shall be parsed by the consumer to be treated as an object or an array. Ignored if the
   * properties examples, content or array are specified.
   *
