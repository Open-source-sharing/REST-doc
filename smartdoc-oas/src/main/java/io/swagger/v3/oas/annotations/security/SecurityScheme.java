...
/**
 * The annotation may be used at class level (also on multiple classes) to add securitySchemes to
 * spec components section.
 *
 * @see <a target="_new"
 *     href="https://github.com/OAI/OpenAPI-Specification/blob/3.0.1/versions/3.0.1.md#securitySchemeObject">Security
 *     Scheme (OpenAPI specification)</a>
 * @see <a target="_new"
 *     href="https://github.com/OAI/OpenAPI-Specification/blob/3.0.1/versions/3.0.1.md#componentsObject">Components
...
public @interface SecurityScheme {
  ...
  /**
   * A short description for security scheme. CommonMark syntax can be used for rich text
   * representation.
   *
  ...
  /**
   * The name of the header or query parameter to be used. Applies to apiKey type. Maps to "name"
   * property of <a target="_new"
   * href="https://github.com/OAI/OpenAPI-Specification/blob/3.0.1/versions/3.0.1.md#securitySchemeObject">Security
   * Scheme (OpenAPI specification)</a>
   *
   ...
   * purposes. Applies to http ("bearer") type.
   *
  ...
  /**
   * Required. An object containing configuration information for the flow types supported. Applies
   * to oauth2 type.
   *
   ...
   * of a URL. Applies to openIdConnect.
   *
