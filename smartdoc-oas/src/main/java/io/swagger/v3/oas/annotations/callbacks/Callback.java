...
/**
 * The annotation may be used at method level to add one ore more callbacks to the operation
 * definition.
 *
 * @see <a target="_new"
 *     href="https://github.com/OAI/OpenAPI-Specification/blob/3.0.1/versions/3.0.1.md#callbackObject">Callback
...
public @interface Callback {
  ...
  /**
   * An absolute URL which defines the destination which will be called with the supplied operation
   * definition.
   *
