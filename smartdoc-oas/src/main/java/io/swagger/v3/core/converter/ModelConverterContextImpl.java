...
public class ModelConverterContextImpl implements ModelConverterContext {
  ...
  // LoggerFactory.getLogger(ModelConverterContextImpl.class);
  ...
  public void defineModel(String name, Schema model, AnnotatedType type, String prevName) {
    ...
    System.err.println(String.format("defineModel %s %s", name, model));
  ...
  public Schema resolve(AnnotatedType type) {
    ...
    System.err.println(String.format("resolve %s", type.getType()));
    ...
    if (converters.hasNext()) {
      ...
      System.err.println("trying extension {}" + converter);
