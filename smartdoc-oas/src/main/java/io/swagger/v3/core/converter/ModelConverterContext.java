...
public interface ModelConverterContext {
  ...
  /**
   * needs to be called whenever a Model is defined which can be referenced from another Model or
   * Property
   *
  ...
  /**
   * needs to be called whenever a Schema is defined which can be referenced from another Model or
   * Property
   *
   * @param name the name of the model
   * @param model the Model
