...
public interface Predicates {
  ...
  /**
   * a composed predicate that represents a short-circuiting logical AND of {@link Predicate
   * predicates}
   *
  ...
  /**
   * a composed predicate that represents a short-circuiting logical OR of {@link Predicate
   * predicates}
   *
   * @param predicates {@link Predicate predicates}
