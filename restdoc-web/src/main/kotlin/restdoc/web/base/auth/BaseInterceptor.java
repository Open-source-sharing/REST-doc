...
/**
 * {@link HandlerMethod} 通用方法抽象
 *
 * <p>{@link HandlerInterceptor} {@link Method}
 *
 * @author maxuefeng
 * @author Maple {@link Annotation} 注解实例调用getClass()方法的结果是一个Proxy对象 具体打印结果是com.sun.proxy.$Proxy72
...
public abstract class BaseInterceptor implements HandlerInterceptor {
  ...
  @Nullable
  public <TYPE extends Annotation> TYPE getApiServiceAnnotation(
      @NonNull Class<TYPE> type, @NonNull Object handler) {
        ...
        .map(
            h -> {
              ...
              return Optional.ofNullable(annotation)
                  .orElse(h.getBeanType().getDeclaredAnnotation(type));
            })
        .orElse(null);
  }
