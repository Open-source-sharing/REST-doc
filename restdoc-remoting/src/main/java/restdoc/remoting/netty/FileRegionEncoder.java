 ...
 * In case we need to encrypt transmission, data being sent should go through the {@link
 * SslHandler}. This encoder ensures this process.
 */
public class FileRegionEncoder extends MessageToByteEncoder<FileRegion> {
   ...
   */
  @Override
  protected void encode(ChannelHandlerContext ctx, FileRegion msg, final ByteBuf out)
      throws Exception {
