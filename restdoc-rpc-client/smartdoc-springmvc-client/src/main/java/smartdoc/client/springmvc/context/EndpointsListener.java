...
public class EndpointsListener implements ApplicationListener<ContextRefreshedEvent> {
  ...
  private void projectApi(
    ...
    Set<HttpApiDescriptor.KeyValuePair> requestHeaders = emptyTemplate.getRequestHeaders();

    HttpApiDescriptor.KeyValuePair requestMimeTypePair =
        requestHeaders.stream()
            .filter(t -> t.getName().equals(HttpHeaders.CONTENT_TYPE))
            .findFirst()
            .orElse(null);
